...
public class SudokuElement {
    ...
    public void removeMinPossibility() {
        System.out.print("BEFORE removing possibilities m: ");
        ...
        try {
            ...
            System.out.println("Removed the value from the possibility "+min+".");
        }
        catch (ArrayIndexOutOfBoundsException e) {
            System.out.println("ERROR! Unable to remove.");
            System.out.println(possibleValues);
        }
        System.out.print("\n" + "AFTER removing possibilities min: ");
        possibleValues.forEach(e -> System.out.print(e+", "));
        System.out.println();
    }
